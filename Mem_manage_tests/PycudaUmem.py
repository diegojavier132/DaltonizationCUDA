# Pycuda Square Function using Unified Memory
...
out = cuda.managed_empty(ARRAY_SIZE, dtype=d_type, mem_flags=cuda.mem_attach_flags.GLOBAL)
...
for i in range(0,loope):
    square(np.uintp(ARRAY_SIZE), out, inp, block=(numThreads, 1, 1), grid=(numBlocks, 1)) 
